...
# Basic convolutional block of the encoder
...
class from_rgb(nn.Module):
    ...
    Convert RGB image to multi-channel feature map for concatenation with feature maps of the same channel size in the network
    """
...
class to_rgb(nn.Module):
    """
    Convert multi-channel feature map to RGB image for input to the discriminator
